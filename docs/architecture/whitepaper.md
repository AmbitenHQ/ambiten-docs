...
- [Adapter Usage Patterns](/adapters/usage-patterns)
...
This page explains Ambiten’s runtime architecture. If you are looking for the behavior this architecture guarantees, see [Execution Guarantees](/architecture/execution-guarantees).
...
| 3. Scope | `AmbitenContext.run()` initializes | AmbitenContext |
...
| Capability | Traditional ODM(Mongoose/Prisma) | Ambiten |
| --- | --- | --- |
